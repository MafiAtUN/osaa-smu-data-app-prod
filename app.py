...
sdg_undata_dashboard_page = st.Page("sdg_dashabord_undata.py", title="SDG UN Data Dashboard", icon=":material/public:")
...
pg = st.navigation([home_page, dashboard_page, wb_dashboard_page, sdg_dashboard_page, sdg_undata_dashboard_page, acled_dashboard_page, chatbot_page, contradictory_analysis_page, pid_checker_page], position='hidden')
